    ...
    <>
      ...
      <div className=' h-screen bg-blue-200
              ...
              <label className='font-bold text-3xl'>
                ค้นหาเบอร์
                <input type='text' className='h-12 w-10 ml-8 drop-shadow-lg '/> 
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-6 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 drop-shadow-lg '/>
                <input type='text' className='h-12 w-10 ml-3 mr-5 drop-shadow-lg '/>
